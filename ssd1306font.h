...
// Changing font and scale does NOT WORK right now have not figured out why so stuck with basic font on smallest size

#define FONT 0 //FONT 0: 6x8 px; FONT 1: 8x16 px
#define SCALE 0 //FONTs can be scaled by 0 (x1); 1 (x2); 2 (x4)

const uint8_t nibbleDouble [] = {
	0x00,0x03,0x0c,0x0f,0x30,0x33,0x3c,0x3f,
	0xc0,0xc3,0xcc,0xcf,0xf0,0xf3,0xfc,0xff,
};

const uint8_t diBitQuad [] = {
	0x00,0x0f,0xf0,0xff,
};

#if FONT == 1
	#define FONT_WIDTH 8
	#define FONT_TABLEOFFSET 750   //8 * 95 = 760
	/* Bigger ASCII 8x16 font */
	const uint8_t ssd1306xled_font[] = {
	...
	#define FONT_WIDTH 6
	#define FONT_TABLEOFFSET 0
	const uint8_t ssd1306xled_font[] = {0};
#endif
